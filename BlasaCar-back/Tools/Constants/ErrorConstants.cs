...
{
    /// <summary>
    ///  Fournit un ensemble de constantes de code d'erreur
    /// </summary>
    public static class ErrorConstants
    {

        public const string BlasacarLoginFailedUserNotExiste = "BLASACAR_LOGIN_FAILED_USER_NOT_EXISTE";
        public const string BlasacarLoginFailedWrongPassword = "BLASACAR_LOGIN_FAILED_WRONG_PASSWORD";
        ...
        public const string BLASACARTravelfailedCreationBook     = "BLASACARTravelfailedCreationBook";
        public const string BLASACARTravelNotFoundException = "BLASACAR_Travel_NotFoundException";
        public const string BLASACARTravel_BookNotFoundException = "BLASACARTravel_BookNotFoundException";
        ...
        public const string BLASACAR_Book_Travel_is_required = "BLASACAR_Book_Travel_is_required";
        public const string BLASACAR_Book_Userid_is_required = "BLASACAR_Book_Userid_is_required";
